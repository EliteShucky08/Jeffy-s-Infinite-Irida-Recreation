...
function onCreatePost()
    ...
    setProperty('healthBarOverlay.x', healthBarPosX - 93)
...
function onUpdatePost()
    ...
    setProperty('iconP1.x', screenWidth - 170)
    setProperty('iconP2.x', 55)
...
function onStepHit()
    ...
    if curStep == 512 then
        doTweenAlpha('accuracyTextFadeIn', 'accuracyText', 0.6, 0.3, 'linear')
    end
