...
class Paths
{
    ...
    {
        var s = returnSound('sounds/$key', modsAllowed);
        if (s == null)
        {
            var msg = '[Paths.sound] ERROR: Sound "$key" could not be found!';
            trace(msg);
            FlxG.log.error(msg);
        }
        return s;
    ...
    {
        var m = returnSound('music/$key', modsAllowed);
        if (m == null)
        {
            var msg = '[Paths.music] ERROR: Music "$key" could not be found!';
            trace(msg);
            FlxG.log.error(msg);
        }
        return m;
    ...
    {
        var s = returnSound('${formatToSongPath(song)}/Inst', 'songs', modsAllowed);
        if (s == null)
        {
            var msg = '[Paths.inst] ERROR: Inst for "$song" could not be found!';
            trace(msg);
            FlxG.log.error(msg);
        }
        return s;
    ...
    inline static public function voices(song:String, postfix:String = null, ?modsAllowed:Bool = true):Sound
    {
        ...
        var v = returnSound(songKey, 'songs', modsAllowed, false);
        if (v == null)
        {
            var msg = '[Paths.voices] ERROR: Voices for "$song" (postfix:$postfix) could not be found!';
            trace(msg);
            FlxG.log.error(msg);
        }
        return v;
    ...
    {
        var s = sound(key + FlxG.random.int(min, max), modsAllowed);
        if (s == null)
        {
            var msg = '[Paths.soundRandom] ERROR: Random sound "$key" in range $min-$max could not be found!';
            trace(msg);
            FlxG.log.error(msg);
        }
        return s;
    ...
    static public function image(key:String, ?parentFolder:String = null, ?allowGPU:Bool = true):FlxGraphic
    {
        ...
        if (currentTrackedAssets.exists(key))
        {
            ...
            var cached = currentTrackedAssets.get(key);
            if (cached == null)
            {
                var msg = '[Paths.image] Warning: Cached asset for "$key" is null!';
                trace(msg);
                FlxG.log.error(msg);
            }
            return cached;
        }
        var graph = cacheBitmap(key, parentFolder, bitmap, allowGPU);
        if (graph == null)
        {
            var msg = '[Paths.image] ERROR: Could not load image "$key" (parentFolder:$parentFolder). Check if the file exists.';
            trace(msg);
            FlxG.log.error(msg);
        }
        return graph;
    ...
    public static function cacheBitmap(key:String, ?parentFolder:String = null, ?bitmap:BitmapData, ?allowGPU:Bool = true):FlxGraphic
    {
        if (bitmap == null)
        {
            ...
            if (bitmap == null)
            {
                var msg = '[Paths.cacheBitmap] ERROR: Bitmap not found: $file | key: $key | parentFolder: $parentFolder';
                trace(msg);
                FlxG.log.error(msg);
                return null;
            }
    ...
    inline static public function getTextFromFile(key:String, ?ignoreMods:Bool = false):String
    {
        ...
        if (FileSystem.exists(path))
            ...
            var msg = '[Paths.getTextFromFile] ERROR: Text file not found at $path for key $key';
            trace(msg);
            FlxG.log.error(msg);
            return null;
        }
        ...
        if (OpenFlAssets.exists(path, TEXT))
            ...
            var msg = '[Paths.getTextFromFile] ERROR: Text asset not found at $path for key $key';
            trace(msg);
            FlxG.log.error(msg);
            return null;
        }
    ...
    static public function getAtlas(key:String, ?parentFolder:String = null, ?allowGPU:Bool = true):FlxAtlasFrames
    {
        ...
        if (imageLoaded == null)
        {
            var msg = '[Paths.getAtlas] ERROR: Could not load image for atlas "$key" (parentFolder:$parentFolder).';
            trace(msg);
            FlxG.log.error(msg);
            return null;
        }
        ...
        var msg2 = '[Paths.getAtlas] ERROR: Could not find atlas xml or json for "$key" (parentFolder:$parentFolder).';
        trace(msg2);
        FlxG.log.error(msg2);
    ...
    inline static public function getSparrowAtlas(key:String, ?parentFolder:String = null, ?allowGPU:Bool = true):FlxAtlasFrames
    {
        ...
        if (imageLoaded == null)
        {
            var msg = '[Paths.getSparrowAtlas] ERROR: Could not load image for sparrow atlas "$key" (parentFolder:$parentFolder).';
            trace(msg);
            FlxG.log.error(msg);
            return null;
        }
    ...
    inline static public function getPackerAtlas(key:String, ?parentFolder:String = null, ?allowGPU:Bool = true):FlxAtlasFrames
    {
        ...
        if (imageLoaded == null)
        {
            var msg = '[Paths.getPackerAtlas] ERROR: Could not load image for packer atlas "$key" (parentFolder:$parentFolder).';
            trace(msg);
            FlxG.log.error(msg);
            return null;
        }
    ...
    inline static public function getAsepriteAtlas(key:String, ?parentFolder:String = null, ?allowGPU:Bool = true):FlxAtlasFrames
    {
        ...
        if (imageLoaded == null)
        {
            var msg = '[Paths.getAsepriteAtlas] ERROR: Could not load image for aseprite atlas "$key" (parentFolder:$parentFolder).';
            trace(msg);
            FlxG.log.error(msg);
            return null;
        }
    ...
    public static function returnSound(key:String, ?path:String, ?modsAllowed:Bool = true, ?beepOnNull:Bool = true)
    {
        ...
        if(!currentTrackedSounds.exists(file))
        {
            ...
            {
                var msg = '[Paths.returnSound] ERROR: SOUND NOT FOUND: $key, PATH: $path';
                trace(msg);
                FlxG.log.error(msg);
