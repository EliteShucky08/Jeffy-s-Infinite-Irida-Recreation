...
class FreeplayState extends MusicBeatState
{
    ...
    override function create()
    {
        ...
        colorBG = new FlxSprite().makeGraphic(FlxG.width, FlxG.height, 0xFFFFFFFF);
        colorBG.scale.set(1.01, 1.01); 
        colorBG.alpha = 0.3;
        add(colorBG);
        // === IRIDA BG END ===
        ...
        colorBG.color = songs[curSelected].color; // set overlay color ONCE
        intendedColor = colorBG.color;
    ...
    {
        // === IRIDA BG/OVERLAY SCROLL ===
        var bgSpd = 20 * elapsed;
        bg1.y -= bgSpd;
        bg2.y -= bgSpd;
        if (bg1.y <= -bg1.height) bg1.y = bg2.y + bg2.height;
        if (bg2.y <= -bg2.height) bg2.y = bg1.y + bg1.height;

        var ovSpd = 40 * elapsed;
        top1.x += ovSpd; top2.x += ovSpd;
        bottom1.x += ovSpd; bottom2.x += ovSpd;
    ...
    function changeSelection(change:Int = 0, playSound:Bool = true)
    {
        ...
        // --- ColorBG does NOT change anymore ---
